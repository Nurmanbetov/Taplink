const passwordForm = document.getElementById("phone-password")

const redirect = "/password-reset";
...
passwordForm.addEventListener('submit', (e) => {
    e.preventDefault()
    var phoneNumberInput = passwordForm['phone_number_password_id'].value.replace(/ /g, '')
    ...
    $.ajax({
            ...
            success: function (response) {
              ...
              firebase.auth().signInWithPhoneNumber(phoneNumber, appVerifier)
                  ...
                  });}else{alert('Такой номер не зарегистрирован на нашем сайте. Введите свой номер телефона или зарегистрируйтесь.')
                  }
            },
